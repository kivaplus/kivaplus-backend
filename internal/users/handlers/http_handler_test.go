...
type TestDependencies struct {
	...
	CompleteProfileUC *MockCompleteProfileService
	Handler           *HTTPHandler
}
...
func setupTestHandler() *TestDependencies {
	...
	mockCompleteProfileUC := new(MockCompleteProfileService)
	mockLogger := logger.New()

	handler := NewHTTPHandler(mockCreateUserUC, mockLoginUC, mockRefreshTokenUC, mockCompleteProfileUC, mockLogger)

	return &TestDependencies{
		CreateUserUC:      mockCreateUserUC,
		LoginUC:           mockLoginUC,
		RefreshTokenUC:    mockRefreshTokenUC,
		CompleteProfileUC: mockCompleteProfileUC,
		Handler:           handler,
	}
}
